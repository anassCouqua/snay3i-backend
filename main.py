...
app.add_middleware(CORSMiddleware,
    allow_origins=["http://localhost:3000","http://localhost:5173","https://snay3i-frontend.vercel.app","https://snay3i-frontend-git-main-anasscouquas-projects.vercel.app"],
